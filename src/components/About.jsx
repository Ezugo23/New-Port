import { BriefcaseBusinessIcon, Code2Icon, User2Icon } from "lucide-react"
            ...
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="space-y-6">
                        <h3 className="text-2xl font-semibold">
                            Passionate Web Developer & AI Chatbot Developer
                        </h3>
             ...
             teamwork and growth.
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center">
                            ...
                            <a href="/src/Iwu Paschal's CV.docx"  download="Iwu_Paschal_CV.docx"  className="px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/10 transition-colors duration-300">
                                Download CV
                            </a>
                        </div>
                    </div>
                        ...
                        <div className="gradient-border p-6 card-hover">
                             <div className="flex items-start gap-4">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-muted-foreground">
                                       Designing intuitive user interfaces and seamless user experiences using design frameworks.
                                    </p>
                                </div>
                            </div>
                        </div>
